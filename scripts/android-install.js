...
module.exports = function (context) {
    ...
    var targetDir  = path.join(projectRoot, "platforms", "android", "src", "cn", "beyondmap", "plugins");
        targetFile = path.join(targetDir, "GpsUploadPlugin.java");
    ...
    if (['after_plugin_add', 'after_plugin_install', 'after_platform_add'].indexOf(context.hook) === -1) {
        ...
        // sync the content
        fs.readFile(path.join(context.opts.plugin.dir, 'src', 'android', 'GpsUploadPlugin.java'),
